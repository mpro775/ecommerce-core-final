...
const ORDER_MANAGER_PERMISSIONS = [
  ...
  PERMISSIONS.ordersEditManual,
  PERMISSIONS.ordersConfirm,
  PERMISSIONS.ordersCancel,
  PERMISSIONS.ordersComplete,
  PERMISSIONS.fulfillmentRead,
  PERMISSIONS.fulfillmentStartPreparing,
  PERMISSIONS.fulfillmentMarkReady,
  PERMISSIONS.fulfillmentDispatch,
  PERMISSIONS.fulfillmentFulfill,
  PERMISSIONS.fulfillmentFail,
  PERMISSIONS.fulfillmentRetry,
  PERMISSIONS.fulfillmentCancel,
  PERMISSIONS.shippingRead,
  PERMISSIONS.shippingWrite,
  PERMISSIONS.paymentsRead,
  PERMISSIONS.paymentsWrite,
  PERMISSIONS.paymentsStartReview,
  PERMISSIONS.paymentsApprove,
  PERMISSIONS.paymentsReject,
  PERMISSIONS.paymentsCollectCod,
...
const INVENTORY_MANAGER_PERMISSIONS = [
  ...
  PERMISSIONS.inventoryRead,
  PERMISSIONS.inventoryWrite,
  PERMISSIONS.inventoryReserve,
  PERMISSIONS.inventoryConsumeReservation,
  PERMISSIONS.inventoryReleaseReservation,
...
const GENERAL_MANAGER_PERMISSIONS = [
  ...
  PERMISSIONS.paymentsRead,
  PERMISSIONS.paymentsWrite,
  PERMISSIONS.paymentsSubmitProof,
  PERMISSIONS.paymentsStartReview,
  PERMISSIONS.paymentsApprove,
  PERMISSIONS.paymentsReject,
  PERMISSIONS.paymentsCollectCod,
  PERMISSIONS.paymentsExpire,
  PERMISSIONS.paymentsCancel,
  PERMISSIONS.inventoryReserve,
  PERMISSIONS.inventoryConsumeReservation,
  PERMISSIONS.inventoryReleaseReservation,
  PERMISSIONS.inventoryAdjust,
  PERMISSIONS.commercialAuditRead,
  PERMISSIONS.promotionsRead,
  PERMISSIONS.promotionsWrite,
  PERMISSIONS.reportsRead,
  PERMISSIONS.reportsExport,
